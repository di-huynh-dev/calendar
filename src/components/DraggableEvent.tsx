...
//         padding: "0.5rem",
//       }}
//       className="absolute w-full bg-blue-400 text-white text-left rounded-xl p-2 border-slate-300 border-2"
//     >
//       <div
//         className={`text-md ${
...
const DraggableEvent: React.FC<DraggableEventProps> = ({
  ...
  return (
    <div
      ...
      className="absolute bg-blue-400 text-white text-left rounded-xl p-2 border-slate-300 border-2"
    >
      <div
        className={`text-md ${
          endTime.getTime() - startTime.getTime() < 31 * 60 * 1000
